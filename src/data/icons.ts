...
const SHELL_BY_PACK: Record<string, (inner: string, viewBox: string) => string> = {
  ...
  "fluent-ui": iconifyShell,
  solar: iconifyShell,
  "icon-park-outline": iconifyShell,
  "icon-park-solid": iconifyShell,
  "icon-park-twotone": iconifyShell,
  healthicons: iconifyShell,
  mynaui: iconifyShell,
  logos: iconifyShell,
  emojione: iconifyShell,
  iconamoon: iconifyShell,
  "fluent-mdl2": iconifyShell,
  "pepicons-pop": iconifyShell,
  "pepicons-pencil": iconifyShell,
  f7: iconifyShell,
  devicon: iconifyShell,
  "file-icons": iconifyShell,
  gg: iconifyShell,
  codicon: iconifyShell,
  "akar-icons": iconifyShell,
  "skill-icons": iconifyShell,
  humbleicons: iconifyShell,
  "eos-icons": iconifyShell,
};
