...
export const ALL_PACKS = [
  ...
  "nature",
  "science",
  // Additional permissively licensed sets (opt-in, see PACK_GROUPS).
  "mdi",
  "hugeicons",
  "iconoir",
  "mingcute",
  ...
  "circle-flags",
  "vscode-icons",
  // Second batch of free sets (opt-in, see PACK_GROUPS).
  "fluent-ui",
  "solar",
  "icon-park-outline",
  "icon-park-solid",
...
export const DEFAULT_SETTINGS: StarIconsSettings = {
  ...
  enabledPacks: {
    ...
    "fluent-ui": false,
    solar: false,
    "icon-park-outline": false,
    "icon-park-solid": false,
    "icon-park-twotone": false,
    healthicons: false,
    mynaui: false,
    logos: false,
    emojione: false,
...
export const PACK_SAMPLE_ICON: Record<string, string> = {
  ...
  "tabler-filled": "home",
  unicons: "apps",
  "unicons-solid": "house-user",
  "unicons-monochrome": "house-user",
  "unicons-thinline": "house-user",
  remix: "home-line",
  phosphor: "house",
...
export const PACK_GROUPS: PackGroup[] = [
  ...
  {
    title: "Flags & file types",
    open: false,
    packs: ["circle-flags", "vscode-icons"],
  },
  {
    title: "Design systems & platforms",
    open: false,
    packs: [
      "icon-park-outline",
      "icon-park-solid",
  ...
  {
    title: "Brands & file types",
    open: false,
    packs: ["logos", "devicon", "skill-icons", "file-icons"],
  },
];
